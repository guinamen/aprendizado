...
ler_banco_dados <- function(arquivo) {
  ...
  imoveis$TIPO_CONSTRUTIVO <- factor(imoveis$TIPO_CONSTRUTIVO, ordered = TRUE, levels = c("LOTE VAGO","BARRACAO COM OCUPACAO NAO RESIDENCIAL","APARTAMENTO COM OCUPACAO NAO RESIDENCIAL", "VAGA DE GARAGEM RESIDENCIAL","VAGA DE GARAGEM NAO RESIDENCIAL","CASA COM OCUPACAO NAO RESIDENCIAL","BARRACAO","SALA","GALPAO","LOJA","APARTAMENTO","CASA"))
